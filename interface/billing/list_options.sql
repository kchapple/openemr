...
--
-- Host: localhost:3306
-- Generation Time: Sep 27, 2011 at 12:35 PM
...
('lists', 'MSP_Categories', 'MSP Categories', 222, 1, 0, '', ''),
...
('MSP_Categories', '15', 'Workers’ Compensation', 40, 0, 0, '', 'Insurance that employers are required to provide to cover employees who become sick or are injured on the job. Note: This type has no age restrictions.'),
('MSP_Categories', '16', 'Federal Agency (Public Health)', 50, 0, 0, '', 'Services that are the direct obligation of another federal, state or local governmental entity.'),
('MSP_Categories', '41', 'Federal Black Lung', 60, 0, 0, '', 'Coverage due to black lung disease and other respiratory conditions caused by coal mining, where a Medicare beneficiary may be entitled to have services reimbursed by the United States Department of Labor'),
('MSP_Categories', '14', 'Automobile/No-Fault', 30, 0, 0, '', 'Insurance coverage (including a self-insured plan) that pays for medical expenses for injuries sustained on the property or premises of the insured, or in the use, occupancy or operation of an automobile regardless of who may have been responsible for cau'),
('MSP_Categories', '13', 'End Stage Renal Disease (ESRD)', 20, 0, 0, '', 'Beneficiaries enrolled with Medicare solely due to renal failure and are insured through their own, or through a family member’s former or current employment. Note: This type has no age restrictions.'),
('MSP_Categories', '12', 'Working Aged', 10, 0, 0, '', 'Beneficiaries age 65 or older who are insured through their or their spouses’ current employment. Employer’s group plan has 20 or more employees. Note: This type must only be used for beneficiaries who are 65 years old or older on the date the service was'),
('MSP_Categories', '42', 'Veterans Affairs', 70, 0, 0, '', 'Veterans who are Medicare-eligible may elect whether Medicare or VA benefits will handle their claims. Note: This type has no age restrictions.'),
('MSP_Categories', '43', 'Disability', 80, 0, 0, '', 'Beneficiaries under the age of 65, who are disabled and insured through their current employment or through the current employment of a family member. The plan has 100 or more employees. Note: If the basis of disability is ESRD, the ESRD type should be us'),
('MSP_Categories', '47', 'Other Liability', 90, 0, 0, '', 'Insurance (including self-insured plans) that provides payment based on legal liability for injury, illness or damage to property. It includes, but is not limited to, automobile liability insurance, uninsured motorist insurance, underinsured motorist insu'),
('msp_remit_codes', '1', '1', 1, 1, 0, '', 'Deductible Amount'),
