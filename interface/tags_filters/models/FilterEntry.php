...
class FilterEntry extends Entry
{
    public function init()
    {
        $this->setColumns(array(
            ...
            new Column(array('width' => '65px', 'behavior' => new ActiveStatic(array('class' => 'effective_date', 'name' => 'effective_date')), 'title' => 'Effective Date', 'data' => 'F.effective_date')),
            new Column(array('width' => '65px', 'behavior' => new ActiveStatic(array('class' => 'expiration_date', 'name' => 'expiration_date')), 'title' => 'Expiration Date', 'data' => 'F.expiration_date')),
