...
use ESign\VerificationIF;
use ESign\SignableIF;
...
class Utils_Verification implements VerificationIF
{
    ...
    public function hash( SignableIF $signable )
    {
    ...
    public function verify( SignableIF $signable )
    {
        $currentHash = $this->hash( $signable );
        $lastStoredHash = $signable->getLastStoredHash();
